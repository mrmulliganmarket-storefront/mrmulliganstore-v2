...
__name2(allowedOrigin, "allowedOrigin");
var CORS = {
...
__name2(sessionSecret, "sessionSecret");
...
__name2(loginThrottled, "loginThrottled");
...
__name2(toTursoArgs, "toTursoArgs");
...
__name2(tursoRequest, "tursoRequest");
...
__name2(tursoPipeline, "tursoPipeline");
...
__name2(tursoExecute, "tursoExecute");
...
__name2(buildDashboard, "buildDashboard");
...
__name2(buildVendors, "buildVendors");
...
__name2(buildInventory, "buildInventory");
...
__name2(buildOrders, "buildOrders");
...
__name2(buildExpenses, "buildExpenses");
...
__name2(buildReviews, "buildReviews");
...
__name2(buildStoreFeatured, "buildStoreFeatured");
...
__name2(buildStoreItem, "buildStoreItem");
...
__name2(buildStoreReviews, "buildStoreReviews");
...
__name2(dailyIpHash, "dailyIpHash");
function escapeHtmlEmail(s) {
  return String(s == null ? "" : s).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;");
}
__name(escapeHtmlEmail, "escapeHtmlEmail");
__name2(escapeHtmlEmail, "escapeHtmlEmail");
...
__name2(sendOrderStatusEmail, "sendOrderStatusEmail");
var worker_default = {
  async fetch(request, env, ctx) {
    ...
    if (request.method === "POST" && path === "/api/admin/generate-description") {
      ...
      try {
        ...
        const clean = /* @__PURE__ */ __name2((v) => String(v == null ? "" : v).replace(/[\r\n]+/g, " ").trim(), "clean");
